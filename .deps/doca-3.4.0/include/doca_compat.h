 ...
 * Honors DOCA_ALLOW_DEPRECATED_API to suppress warnings when requested.
 */
...
#if defined(DOCA_COMPAT_HELPERS) && !defined(DOCA_DPA_DEVICE)
...
#endif /* DOCA_COMPAT_HELPERS && !DOCA_DPA_DEVICE */
