...
/**
 * @brief This method allocates a doca_task_batch of doca_eth_txq_task_send tasks.
 *
 * @note Supported for DOCA ETH TXQ instance for CPU only.
 *
 * @param [in] eth_txq
...
/**
 * @brief This method allocates a doca_task_batch of doca_eth_txq_task_lso_send tasks.
 *
 * @note Supported for DOCA ETH TXQ instance for CPU only.
 *
 * @param [in] eth_txq
