 ...
 *
 * @note The start operation is time consuming. As a best practice, start the memory map in the initialization
 * phase. Do not call this function on the fast path unless necessary.
 *
 * @param [in] mmap
